...
If you don't have an AWS account, and want to setup only the frontend locally, please follow this [Readme](./frontend_readme.md)
...
2.  Create a new Stack: `With new resources(standard)`
    ...
    -   Upload the [template.json](./template.json) file from this repo.
