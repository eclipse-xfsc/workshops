...
public class ClientConfig {
  ...
  @Bean
  public QueryClient userClient(@Value("${federated-catalogue.base-uri}") final String baseUri, WebClient webClient) {
      return new QueryClient(baseUri, webClient);
  }

  @Bean
  public SelfDescriptionClient uselfDescriptionClient(@Value("${federated-catalogue.base-uri}") final String baseUri, WebClient webClient) {
      return new SelfDescriptionClient(baseUri, webClient);
  }
